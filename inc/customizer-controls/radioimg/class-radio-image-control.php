...
if( ! class_exists( 'TODO_Radio_Image_Control' ) ){
	/**
	 * Radio Image control (modified radio).
    */
	class TODO_Radio_Image_Control extends WP_Customize_Control {

		public $type = 'todo-radio-image';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'todo-radio-image', get_template_directory_uri() . '/inc/customizer-controls/radioimg/radio-image.css', null );
            wp_enqueue_script( 'todo-radio-image', get_template_directory_uri() . '/inc/customizer-controls/radioimg/radio-image.js', array( 'jquery' ), false, true ); //for radio-image                
        }
